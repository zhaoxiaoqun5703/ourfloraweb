class Image < ActiveRecord::Base
  ...
  has_attached_file :image,
                    ...
                    :path => ":rails_root/app/assets/images/species_images/:species_name/:style_:basename.:extension",
                    :url  => "/assets/species_images/:species_name/:style_:basename.:extension"
