...
ActiveRecord::Schema.define(version: 20150204002833) do
  ...
  add_index "species_trails", ["species_id"], name: "index_species_trails_on_species_id"
  add_index "species_trails", ["trail_id"], name: "index_species_trails_on_trail_id"
